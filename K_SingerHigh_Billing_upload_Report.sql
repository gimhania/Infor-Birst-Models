K_SingerHigh_Billing_upload_Report_

SELECT summaryUltra.MonthYear,
	ROUND(SUM(summaryUltra.SINVAS3),3) AS SINVAS3,
	ROUND(SUM(summaryUltra.SINVAS2),3) AS SINVAS2,
	ROUND(SUM(summaryUltra.SINVAS4),3) AS SINVAS4,
	ROUND(SUM(summaryUltra.SINVAS1),3) AS SINVAS1,
	ROUND(SUM(summaryUltra.SINADDHNM),3) AS SINADDHNM,
	ROUND(SUM(summaryUltra.SINADDSTM),3) AS SINADDSTM,
	ROUND(SUM(summaryUltra.SINADDSTL),3) AS SINADDSTL,
	ROUND(SUM(summaryUltra.SINDAILYCAPM),3) AS SINDAILYCAPM,
	ROUND(SUM(summaryUltra.SINDAILYCAPL),3) AS SINDAILYCAPL,
	ROUND(SUM(summaryUltra.SINADDHNL),3) AS SINADDHNL
